...
"""autogenerated by genpy from deepbuilder/ro_plan_motionRequest.msg. Do not edit."""
import sys
...
class ro_plan_motionRequest(genpy.Message):
  _md5sum = "a5e1103996b2665386a0e743d1712fe5"
  _type = "deepbuilder/ro_plan_motionRequest"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """float32[] first_point_joint_states
float32[] way_points
float32 speed
"""
  __slots__ = ['first_point_joint_states','way_points','speed']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       first_point_joint_states,way_points,speed
    ...
    """
    if args or kwds:
      super(ro_plan_motionRequest, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.first_point_joint_states is None:
        self.first_point_joint_states = []
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.first_point_joint_states)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.first_point_joint_states))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.first_point_joint_states = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.first_point_joint_states.tostring())
      length = len(self.way_points)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.first_point_joint_states = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
...
def _get_struct_f():
    ...
    return _struct_f
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from deepbuilder/ro_plan_motionResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class ro_plan_motionResponse(genpy.Message):
  _md5sum = "5eacc727a54fe39f63d68b3d3f9a475e"
  _type = "deepbuilder/ro_plan_motionResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ro_plan_motionResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
def _get_struct_2i():
    ...
    return _struct_2i
class ro_plan_motion(object):
  _type          = 'deepbuilder/ro_plan_motion'
  _md5sum = '79a5a45e866664a192667e3d0dcdaa5f'
  _request_class  = ro_plan_motionRequest
  _response_class = ro_plan_motionResponse
