...
class ro_update_state_meshRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ro_update_state_meshRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ro_update_state_meshRequest
    let len;
    let data = new ro_update_state_meshRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ro_update_state_meshRequest(null);
...
class ro_update_state_meshResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.message = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ro_update_state_meshResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ro_update_state_meshResponse
    let len;
    let data = new ro_update_state_meshResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'deepbuilder/ro_update_state_meshResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ro_update_state_meshResponse(null);
...
module.exports = {
  Request: ro_update_state_meshRequest,
  Response: ro_update_state_meshResponse,
  md5sum() { return '230cfe3cf22bf1c93dac2ac217ea4d24'; },
  datatype() { return 'deepbuilder/ro_update_state_mesh'; }
};
