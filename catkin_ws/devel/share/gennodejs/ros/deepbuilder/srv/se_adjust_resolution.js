...
class se_adjust_resolutionRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type se_adjust_resolutionRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type se_adjust_resolutionRequest
    let len;
    let data = new se_adjust_resolutionRequest(null);
  ...
  static datatype() {
    ...
    return 'deepbuilder/se_adjust_resolutionRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new se_adjust_resolutionRequest(null);
...
class se_adjust_resolutionResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.oldValue = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type se_adjust_resolutionResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type se_adjust_resolutionResponse
    let len;
    let data = new se_adjust_resolutionResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'deepbuilder/se_adjust_resolutionResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new se_adjust_resolutionResponse(null);
...
module.exports = {
  Request: se_adjust_resolutionRequest,
  Response: se_adjust_resolutionResponse,
  md5sum() { return 'c347af19957c4bfd6fa7272ca95ca3d6'; },
  datatype() { return 'deepbuilder/se_adjust_resolution'; }
};
