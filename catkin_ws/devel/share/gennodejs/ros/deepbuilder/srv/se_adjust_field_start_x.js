...
class se_adjust_field_start_xRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type se_adjust_field_start_xRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type se_adjust_field_start_xRequest
    let len;
    let data = new se_adjust_field_start_xRequest(null);
  ...
  static datatype() {
    ...
    return 'deepbuilder/se_adjust_field_start_xRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new se_adjust_field_start_xRequest(null);
...
class se_adjust_field_start_xResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.oldValue = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type se_adjust_field_start_xResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type se_adjust_field_start_xResponse
    let len;
    let data = new se_adjust_field_start_xResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new se_adjust_field_start_xResponse(null);
...
module.exports = {
  Request: se_adjust_field_start_xRequest,
  Response: se_adjust_field_start_xResponse,
  md5sum() { return 'c347af19957c4bfd6fa7272ca95ca3d6'; },
  datatype() { return 'deepbuilder/se_adjust_field_start_x'; }
};
