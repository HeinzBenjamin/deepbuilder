...
class ex_writeRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ex_writeRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ex_writeRequest
    let len;
    let data = new ex_writeRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ex_writeRequest(null);
...
class ex_writeResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ex_writeResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ex_writeResponse
    let len;
    let data = new ex_writeResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'deepbuilder/ex_writeResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ex_writeResponse(null);
...
module.exports = {
  Request: ex_writeRequest,
  Response: ex_writeResponse,
  md5sum() { return '93beb009a54ccf54fefb5b85020d0e0d'; },
  datatype() { return 'deepbuilder/ex_write'; }
};
