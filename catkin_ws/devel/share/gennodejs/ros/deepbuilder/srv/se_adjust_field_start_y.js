...
class se_adjust_field_start_yRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type se_adjust_field_start_yRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type se_adjust_field_start_yRequest
    let len;
    let data = new se_adjust_field_start_yRequest(null);
  ...
  static datatype() {
    ...
    return 'deepbuilder/se_adjust_field_start_yRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new se_adjust_field_start_yRequest(null);
...
class se_adjust_field_start_yResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.oldValue = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type se_adjust_field_start_yResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type se_adjust_field_start_yResponse
    let len;
    let data = new se_adjust_field_start_yResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'deepbuilder/se_adjust_field_start_yResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new se_adjust_field_start_yResponse(null);
...
module.exports = {
  Request: se_adjust_field_start_yRequest,
  Response: se_adjust_field_start_yResponse,
  md5sum() { return 'c347af19957c4bfd6fa7272ca95ca3d6'; },
  datatype() { return 'deepbuilder/se_adjust_field_start_y'; }
};
