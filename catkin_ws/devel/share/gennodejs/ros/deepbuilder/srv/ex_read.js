...
class ex_readRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ex_readRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ex_readRequest
    let len;
    let data = new ex_readRequest(null);
  ...
  static datatype() {
    ...
    return 'deepbuilder/ex_readRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ex_readRequest(null);
...
class ex_readResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ex_readResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ex_readResponse
    let len;
    let data = new ex_readResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ex_readResponse(null);
...
module.exports = {
  Request: ex_readRequest,
  Response: ex_readResponse,
  md5sum() { return '7848c669d219de11243ab460d9130d88'; },
  datatype() { return 'deepbuilder/ex_read'; }
};
