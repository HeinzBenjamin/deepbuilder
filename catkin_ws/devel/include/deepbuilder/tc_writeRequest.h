// Generated by gencpp from file deepbuilder/tc_writeRequest.msg
// DO NOT EDIT!


#ifndef DEEPBUILDER_MESSAGE_TC_WRITEREQUEST_H
#define DEEPBUILDER_MESSAGE_TC_WRITEREQUEST_H
...
struct tc_writeRequest_
{
  typedef tc_writeRequest_<ContainerAllocator> Type;
  ...
  tc_writeRequest_(const ContainerAllocator& _alloc)
    : var_names(_alloc)
    , types(_alloc)
    , values(_alloc)  {
  (void)_alloc;
  ...
  typedef boost::shared_ptr< ::deepbuilder::tc_writeRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::deepbuilder::tc_writeRequest_<ContainerAllocator> const> ConstPtr;

}; // struct tc_writeRequest_

typedef ::deepbuilder::tc_writeRequest_<std::allocator<void> > tc_writeRequest;

typedef boost::shared_ptr< ::deepbuilder::tc_writeRequest > tc_writeRequestPtr;
typedef boost::shared_ptr< ::deepbuilder::tc_writeRequest const> tc_writeRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::deepbuilder::tc_writeRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::deepbuilder::tc_writeRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::deepbuilder::tc_writeRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::deepbuilder::tc_writeRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::deepbuilder::tc_writeRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::deepbuilder::tc_writeRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::deepbuilder::tc_writeRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::deepbuilder::tc_writeRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::deepbuilder::tc_writeRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::deepbuilder::tc_writeRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x5a051493a672198aULL;
  static const uint64_t static_value2 = 0xbf7a5e451e21591eULL;
};

template<class ContainerAllocator>
struct DataType< ::deepbuilder::tc_writeRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::deepbuilder::tc_writeRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::deepbuilder::tc_writeRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::deepbuilder::tc_writeRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::deepbuilder::tc_writeRequest_<ContainerAllocator>& v)
  {
...
#endif // DEEPBUILDER_MESSAGE_TC_WRITEREQUEST_H
