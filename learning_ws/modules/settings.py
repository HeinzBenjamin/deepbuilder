...
######################################################################
HOME_POSE = HOME_POSITION = [1.2228,-1.6317,1.1287,0.50297,1.2228,3.1416]
HOME_SCANNING_POSE = [1.2032,-1.4085,1.7855,0.063,1.194,-3.0973]
#HOME_SCANNING_POSE = [1.11,-1.652,1.881,0.229,1.11,3.1416]
...
DISTANCE_TCP_STATE_MAX = 1701.4 #millimeter
DISTANCE_TCP_STATE_LOW = 90.0 #lower threshold, any distance lower than that is considered perfect

MAX_AREA = 750.0 * 750.0 #sqmm
MAX_DEFORMATION = 100.0 #sqmm because deformation is average square distance of tcps to deformed tcps
