...
######################################################################
ACTION_LIMITS = {
    'A0_lower': -0.5 * np.pi, 'A0_upper': 1.5 * np.pi,
    'A1_lower': -np.pi, 'A1_upper': 0.0,
    'A2_lower': -0.5 * np.pi, 'A2_upper': 1.5 * np.pi,
    'A3_lower': -np.pi, 'A3_upper': np.pi,
    'A4_lower': -0.5 * np.pi, 'A4_upper': 1.5 * np.pi,
    'A5_lower': 0.0, 'A5_upper': 2.0 * np.pi,
    'A6_lower': -np.pi, 'A6_upper': np.pi
}
...
LARGEST_POSSIBLE_DISTANCE_TCP_STATE = 2500.0 #millimeter
